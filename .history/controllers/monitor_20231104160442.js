...
const refreshFrontApp = async (req, res) => {
    const scriptPath = './scripts/refresh_front_react_app.sh';
...
const refreshMySQLConnectorRepo = async (req, res) => {
